...
_TEAM = _descriptor.EnumDescriptor(
  name='Team',
  full_name='proto.simulation.Team',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_DIVISION = _descriptor.EnumDescriptor(
  name='Division',
  full_name='proto.simulation.Division',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_ROBOTID = _descriptor.Descriptor(
  name='RobotId',
  full_name='proto.simulation.RobotId',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='proto.simulation.RobotId.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='team', full_name='proto.simulation.RobotId.team', index=1,
